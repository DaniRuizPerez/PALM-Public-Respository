  ...
  nameOfNetwork = paste(folder,"Networks/HEGTM_Skeleton/TMGHVariousAlignments/3Parents/","human_ibd_microbiota_genes_metabolites_dbn_sample_alignment_sr14d_top100x100_host_metabolites_reference_dbnIntraBoot.graphml",sep="")
  nameOfNetwork = paste(folder,"Networks/HEGTM_Skeleton/TMGHVariousAlignments/3Parents/","human_ibd_microbiota_genes_metabolites_dbn_sample_alignment_sr14d_top100x100_host_taxa_reference_dbnIntraBoot.graphml",sep="")
  nameOfNetwork = paste(folder,"Networks/HEGTM_Skeleton/TMGHVariousAlignments/3Parents/","human_ibd_microbiota_genes_metabolites_dbn_sample_noalignment_sr14d_top100x100_host_genes_reference_dbnIntraBoot.graphml",sep="")
  nameOfNetwork = paste(folder,"Networks/HEGTM_Skeleton/TMGHVariousAlignments/3Parents/","human_ibd_microbiota_genes_metabolites_dbn_sample_noalignment_sr14d_top100x100_host_metabolites_reference_dbnIntraBoot.graphml",sep="")
  nameOfNetwork = paste(folder,"Networks/HEGTM_Skeleton/TMGHVariousAlignments/3Parents/","human_ibd_microbiota_genes_metabolites_dbn_sample_noalignment_sr14d_top100x100_host_taxa_reference_dbnIntraBoot.graphml",sep="")
